package org.brijframework.college.util;
...
public class GeneratePdfReport {
	...
	public static ByteArrayInputStream citiesReport(HttpServletRequest request, StudentDTO student, GatePassDTO gate) {
		...
		try {
			 ...
			 * // imagePath += "/img/agschool.jpg"; imagePath += "/img/nida.jpg";
			 */
			...
			cell.addElement(new Paragraph("Gate Pass No.     " + gate.getGatePassId() + "", font));
			table3.addCell(cell);
			...
			cell = new PdfPCell();
			cell.setBorder(Rectangle.NO_BORDER);
			cell.addElement(new Paragraph("Student Id       " + student.getStudentId() + "", font));
			table3.addCell(cell);

			cell = new PdfPCell();
			cell.setBorder(Rectangle.NO_BORDER);
			cell.addElement(new Paragraph("Date        " + gate.getLeavingDate() + "", font));
			table3.addCell(cell);
			...
			cell = new PdfPCell();
			cell.setBorder(Rectangle.NO_BORDER);
			cell.addElement(new Paragraph("Time       " + gate.getLeavingTime() + "", font));
			table3.addCell(cell);

			cell = new PdfPCell();
			cell.setBorder(Rectangle.NO_BORDER);
			cell.addElement(new Paragraph("Name        " + student.getFirstName() + " " + student.getMiddleName() + " "
			...
			cell.addElement(new Paragraph(
					"Class        " + student.getClassName() + "  " + student.getSectionName() + "\n", font));
			table3.addCell(cell);
			...
			paragraph3.add(new Chunk(" Principal           Class Teacher         Accompanied By",
					FontFactory.getFont(FontFactory.HELVETICA_BOLD, 9)));
