...
public class StudentsAdmissionDaoImpl extends DAOImpl<Integer, Students>
	...
	@Transactional
	public Students getActiveStudentById(Integer id) {
	...
	public Students getInActiveStudentById(Integer id) {
		return (Students) (sessionFactory.getCurrentSession()
				.createCriteria(Students.class)
	...
	@Override
	public List<Students> getStudentbyAdmNo(Integer admissionNo) {
		return (List<Students>) sessionFactory.getCurrentSession()
				.createCriteria(Students.class)
				.add(Restrictions.eq("active", true))
	...
	@Override
	public Students checkExistStudent(Integer studentId, int sessionId) {
		return (Students) (sessionFactory.getCurrentSession()
				.createCriteria(Students.class)
				.add(Restrictions.eq("session.sessionId", sessionId))
				.add(Restrictions.eq("active", true))
