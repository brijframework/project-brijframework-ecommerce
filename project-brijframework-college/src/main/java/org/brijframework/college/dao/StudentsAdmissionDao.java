...
public interface StudentsAdmissionDao extends DAO<Integer, Students> {
	...
	Students getActiveStudentById(Integer id);
	...
	List<Students> getStudentbyAdmNo(Integer admissionNo);
	...
	Students checkExistStudent(Integer studentId, int sessionId);
