...
public interface StudentFeeSubmissionDetailsDao extends
	...
	List<StudentFeeSubmissionDetails> getStudentFeeSubmissionDetail(
			Integer studentAdmissionNo, int sectionId, int classId,
	...
	List<StudentFeeSubmissionDetails> getallsubmissiondetails(
			Integer admissionNo, int sessionId);

	List<Integer> getallsubmissiondetailsLfnoByAdmissionNo(Integer admissionNo);
	...
	StudentFeeSubmissionDetails getDefaulters(int sessionId, int classId,
			int sectionId, int monthId, Integer admissionNo);
	...
	public List<Integer> getallDistinctSlipNo(int sessionId, Integer studentId);
	...
	public List<Integer> getMonthIds(int sessionid, Integer studentId);

	public List<Integer> getMonthIdsBySlipNo(int slipNo);

	public List<Integer> getallDistinctSlipNoBySessionId(int sessionId);

	public List<Integer> getMonthsId(int sessionId, Integer studentId);

	public List<Integer> getInprogressMonthsId(int sessionId, Integer studentId);

	List<Integer> getReceiptformonth(int monthId, int sessionId, Date date);

	public Integer getLastMonthIdOfReciept(int slipNo);

	StudentFeeSubmissionDetails findlastpayedmonthbystudentId(Integer studentId,
			Integer sessionId);
	...
	List<StudentFeeSubmissionDetails> getSubmissionforsstudentinMonth(
			...
			Integer studentAdmissionNo, int monthId);

	List<StudentFeeSubmissionDetails> getSubmissionforsstudent(int sessionId,
			int classId, int sectionId, Integer studentAdmissionNo);
	...
	List<Integer> getByCommonRecieptNo(int commonRecieptNo);
	List<Integer> getByCommonRecieptNoAndStudentAddNo(int commonRecieptNo,Integer studentAddmissionNo);
	StudentFeeSubmissionDetails getByCommonRecieptNoStudentAddNo(int commonRecieptNo,Integer studentAddmissionNo);
