...
public class DressPaymentDTO {
	
	private int allotDressId;
	private int dressId;
	...
	public int getDressPaymentId() {
		return dressPaymentId;
	}
	public void setDressPaymentId(int dressPaymentId) {
	...
	public int getAllotDressId() {
		return allotDressId;
	}
	public void setAllotDressId(int allotDressId) {
