...
public class LibraryController {
	...
	public String getIssuedBookByStudentId(@RequestParam Integer studentId)
			throws JsonProcessingException 
	{
	...
	public String newIssueBook(@ModelAttribute("issueBookDTO") IssueBookDTO issueBookDTO) 
	   {
		...
		issueBookService.issueBookToStudent(issueBookDTO.getIssueBookId(),issueBookDTO.getStudentId(), issueBookDTO.getIsbn());
		libraryService.updateLibraryBook(issueBookDTO.getIssueBookId(),issueBookDTO.getStudentId());
