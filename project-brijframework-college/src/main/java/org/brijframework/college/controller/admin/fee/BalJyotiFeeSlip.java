...
public class BalJyotiFeeSlip  extends AbstractPdfView {
	@Override
	...
	protected void buildPdfDocument(Map<String, Object> model,
		...
		paragraph
				.add(new Chunk(
						"FEE RECEIPT\nBAL JYOTI Sr.Sec. SCHOOL\nLAL KUAN SHAHAPUR BAMHETA, GHAZIABAD,",
						font));
		...
		pCell = new PdfPCell();
		pCell.setBorder(Rectangle.NO_BORDER);
		pCell.addElement(new Paragraph("FR-"+String.valueOf(commonDTO.getReceiptNo()), font));
		table3.addCell(pCell);
		pCell = new PdfPCell();
		pCell.setBorder(Rectangle.NO_BORDER);
		...
		pCell = new PdfPCell();
		pCell.setBorder(Rectangle.NO_BORDER);
		pCell.addElement(new Paragraph("Fee for month(s):", font));
		table3.addCell(pCell);
		pCell = new PdfPCell();
		pCell = new PdfPCell();
		pCell.setBorder(Rectangle.NO_BORDER);
		...
		for (StudentDTO studentDTO : commonDTO.getStudentDTOs()) {
			pCell = new PdfPCell();
			pCell.setBorder(Rectangle.NO_BORDER);
			pCell.addElement(new Paragraph("Adm.No.", font));
			table3.addCell(pCell);
			pCell = new PdfPCell();
			pCell = new PdfPCell();
			pCell.setBorder(Rectangle.NO_BORDER);
			...
			pCell = new PdfPCell();
			pCell.setBorder(Rectangle.NO_BORDER);
			pCell.addElement(new Paragraph("Student Name", font));
			table3.addCell(pCell);
			pCell = new PdfPCell();
			pCell = new PdfPCell();
			pCell.setBorder(Rectangle.NO_BORDER);
		...
		StudentFeeSubmissionDetailsDTO studentFeeSubmissionDetailsDTO = commonDTO
			...
			words=studentFeeSubmissionDetailsDTO.getPaidAmountInWord();
			if (studentFeeSubmissionDetailsDTO.getChequeNo() != null) {
				chequeNo = studentFeeSubmissionDetailsDTO.getChequeNo();
				bank=studentFeeSubmissionDetailsDTO.getBankName();
		...
		pCell.setBorder(Rectangle.NO_BORDER);
		paragraph = new Paragraph();
		paragraph.add(new Chunk("Pay Mode " + paidBy + ".",
				FontFactory.getFont(FontFactory.TIMES_BOLD, 9)));
		paragraph.setAlignment(Element.ALIGN_LEFT);
		pCell.addElement(paragraph);
		paragraph = new Paragraph(new Chunk("Draft/Cheque No-" + chequeNo,
				FontFactory.getFont(FontFactory.TIMES_BOLD, 8)));
		paragraph.setAlignment(Element.ALIGN_LEFT);
		pCell.addElement(paragraph);
		paragraph = new Paragraph(new Chunk(
				"Bank-"+bank+"\nThanks for paying"+words+"Only", FontFactory.getFont(
						FontFactory.TIMES_BOLD, 8)));
		paragraph.setAlignment(Element.ALIGN_LEFT);
		pCell.addElement(paragraph);

		paragraph = new Paragraph(new Chunk("Signature",
