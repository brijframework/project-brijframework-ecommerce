...
public class FeePaymentAjaxController {
	...
	public @ResponseBody String getStudentFeePayMentDetails(
			@RequestParam Integer studentAdmissionNo, @RequestParam int sessionId)
			throws JsonProcessingException {
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("StudentDTO", studentsAdmissionService.getStudentId(studentAdmissionNo));
	...
	public @ResponseBody String getPaymentDetails(
			@RequestParam Integer studentAdmissionNo)
			throws JsonProcessingException {
