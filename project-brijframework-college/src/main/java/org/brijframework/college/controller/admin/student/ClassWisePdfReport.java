...
public class ClassWisePdfReport extends AbstractPdfView {
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document,
		...
		table.addCell(cell);
		// write table header
		cell.setPhrase(new Phrase("Father's Name", font));
		table.addCell(cell);
...

		{
			...
			table.addCell(dto.getFirstName() + " " + dto.getMiddleName() + " "
					+ dto.getLastName());
		...
		document.add(new Paragraph("Students List of class " + classes
				+ "\nDate:" + today));
		document.add(table);
