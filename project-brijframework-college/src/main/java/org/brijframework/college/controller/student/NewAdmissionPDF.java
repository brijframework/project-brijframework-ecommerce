...
public class NewAdmissionPDF extends AbstractPdfView {
	@Override
	...
	protected void buildPdfDocument(Map<String, Object> model,
		...
		Font font = FontFactory.getFont(FontFactory.TIMES,7);
		...
		pCell = new PdfPCell();
		pCell.setBorder(Rectangle.NO_BORDER);
		pCell.addElement(new Paragraph("MotherTongue", font));
		table15.addCell(pCell);
		...
		pCell = new PdfPCell();
		pCell.setBorder(Rectangle.NO_BORDER);
		pCell.addElement(new Paragraph("Date of Birth(in words)", font));
		table16.addCell(pCell);
		pCell = new PdfPCell();
		pCell.setBorder(Rectangle.NO_BORDER);
		pCell.addElement(new Paragraph("dobs", font));
		table16.addCell(pCell);
		pCell = new PdfPCell();
		pCell.setBorder(Rectangle.NO_BORDER);
		pCell.addElement(new Paragraph("(in Figures)", font));
		table16.addCell(pCell);
		pCell = new PdfPCell();
		pCell.setBorder(Rectangle.NO_BORDER);
		pCell.addElement(new Paragraph("infigures", font));
		table16.addCell(pCell);
		pCell = new PdfPCell();
		pCell.setBorder(Rectangle.NO_BORDER);
		...
		pCell = new PdfPCell();
		pCell.setBorder(Rectangle.NO_BORDER);
		pCell.addElement(new Paragraph("disability", font));
		table16.addCell(pCell);
		...
		pCell.addElement(new Chunk(img1, 15, -5));
		pCell.setBorder(Rectangle.NO_BORDER);
		table14.addCell(pCell);
		...
		pCell = new PdfPCell();
		pCell.setBorder(Rectangle.NO_BORDER);
		pCell.addElement(new Paragraph("income", font));
		table18.addCell(pCell);
		pCell = new PdfPCell();
		pCell.setBorder(Rectangle.NO_BORDER);
		pCell.addElement(new Paragraph("", font));
		...
		pCell = new PdfPCell();
		pCell.setBorder(Rectangle.NO_BORDER);
		pCell.addElement(new Paragraph("phone", font));
		table18.addCell(pCell);
		pCell = new PdfPCell();
		pCell.setBorder(Rectangle.NO_BORDER);
		pCell.addElement(new Paragraph("", font));
		...
		pCell = new PdfPCell();
		pCell.setBorder(Rectangle.NO_BORDER);
		pCell.addElement(new Paragraph("addressss", font));
		table19.addCell(pCell);
		pCell = new PdfPCell();
		pCell.setBorder(Rectangle.NO_BORDER);
		pCell.addElement(new Paragraph("Ph..", font));
		...
		paragraph = new Paragraph();
		paragraph.add(new Chunk("We/I hereby declare that the information given above is correct to the best of our/ my \n knowledge and that nothing has neen concealed there from.If any information is found to be\n", font));
		paragraph.add(new Chunk("incorrect at any stage, we/I will unconditionally accept whatever action the school takes.\n", font));
		paragraph.add(new Chunk("If selected for admission.We/I undertake to ensure that our/my ward and me/I abide by all \n the rules and regulations of the school as down from time to time and as given the\n", font));
		paragraph.add(new Chunk("SCHOOL DIARY and to pay all school dues of our /my ward in time.We/I also undertake full responsibility of good conduct of our/my ward in the school.", font));
		pCell = new PdfPCell();
		pCell.setBorder(Rectangle.NO_BORDER);
		pCell.addElement(paragraph);
       ...
       // chunk.setUnderline(+1f,-2f);
		...
		pCell = new PdfPCell();
		pCell.setBorder(Rectangle.NO_BORDER);
		pCell.addElement(new Paragraph("Signature of Father", font));
		table24.addCell(pCell);
		pCell = new PdfPCell();
		pCell.setBorder(Rectangle.NO_BORDER);
		pCell.addElement(new Paragraph("Signature of Mother", font));
		table24.addCell(pCell);
		pCell = new PdfPCell();
		pCell.setBorder(Rectangle.NO_BORDER);
		...
		pCell = new PdfPCell();
		pCell.setBorder(Rectangle.NO_BORDER);
		pCell.addElement(new Paragraph("FOR OFFICE USE", font));
		...
		pCell = new PdfPCell();
		pCell.setBorder(Rectangle.NO_BORDER);
		pCell.addElement(new Paragraph("To appear for written test/interview on ", font));
		table26.addCell(pCell);
		pCell = new PdfPCell();
		pCell.setBorder(Rectangle.NO_BORDER);
		pCell.addElement(new Paragraph("dates", font));
		table26.addCell(pCell);
		...
		pCell = new PdfPCell();
		pCell.setBorder(Rectangle.NO_BORDER);
		pCell.addElement(new Paragraph("Admit in Class", font));
		table26.addCell(pCell);
		pCell = new PdfPCell();
		pCell.setBorder(Rectangle.NO_BORDER);
		pCell.addElement(new Paragraph("classes", font));
		table26.addCell(pCell);
		
		pCell = new PdfPCell();
		pCell.setBorder(Rectangle.NO_BORDER);
		pCell.addElement(new Paragraph("Director/Principal", font));
		table26.addCell(pCell);
		pCell = new PdfPCell();
		pCell.setBorder(Rectangle.NO_BORDER);
		pCell.addElement(new Paragraph("classes", font));
		...
		pCell = new PdfPCell();
		pCell.setBorder(Rectangle.NO_BORDER);
		pCell.addElement(new Paragraph("numbers", font));
		table27.addCell(pCell);
		pCell = new PdfPCell();
		pCell.setBorder(Rectangle.NO_BORDER);
		pCell.addElement(new Paragraph("Date.", font));
		...
		pCell = new PdfPCell();
		pCell.setBorder(Rectangle.NO_BORDER);
		pCell.addElement(new Paragraph("vfr", font));
		table27.addCell(pCell);
		pCell = new PdfPCell();
		pCell.setBorder(Rectangle.NO_BORDER);
		pCell.addElement(new Paragraph("Fee Receipt No..", font));
		table27.addCell(pCell);
		pCell = new PdfPCell();
		pCell.setBorder(Rectangle.NO_BORDER);
		pCell.addElement(new Paragraph("verv", font));
		table27.addCell(pCell);
		pCell = new PdfPCell();
		pCell.setBorder(Rectangle.NO_BORDER);
		pCell.addElement(new Paragraph("Date", font));
		...
		pCell = new PdfPCell();
		pCell.setBorder(Rectangle.NO_BORDER);
		pCell.addElement(new Paragraph("rv", font));
		table27.addCell(pCell);
		
		PdfPTable table28 = new PdfPTable(1);
		table28.setWidthPercentage(100);
		paragraph = new Paragraph();
		paragraph.add(new Chunk("Office Asst. Sign_________________________", font));
		...
		paragraph = new Paragraph();
		paragraph.add(new Chunk("Nida Inter College , Massuri, Ghaziabad\n"
				+ "", font));
		paragraph.setAlignment(Element.ALIGN_CENTER);
		pCell = new PdfPCell();
		pCell.setBorder(Rectangle.NO_BORDER);
