...
public class StudentsAdmissionServiceImpl extends
		CRUDServiceImpl<Integer, Students, StudentsAdmissionDao> implements
	...
	@Override
	public void setActiveById(Integer id) {
	...
	@Override
	public StudentDTO findStudentData(Integer id) {
	...
	@Override
	public StudentDTO findStudentDetailsforPDF(Integer studentId) {
		SimpleDateFormat df = new SimpleDateFormat("dd-MM-yyyy");
	...
	public String transferStudent(int id) throws ParseException {
		...
		students.setStudentId(Integer.parseInt(uniqueNo[2]));
	...
	@Override
	public String findStudentbalance(Integer studentId) {
		String result = "";
		Session current = sessionDao.findCurrentSession();
	...
	@Override
	public StudentDTO findStudentPerforma(Integer studentId) {
		SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd");
	...
	@Override
	public void ReadmitStudent(Integer id) {
