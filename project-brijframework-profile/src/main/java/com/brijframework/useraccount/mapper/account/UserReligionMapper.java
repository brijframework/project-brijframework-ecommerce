...
import com.brijframework.useraccount.beans.EOUserReligionDTO;
...
public interface UserReligionMapper extends RQRSMapper<UserReligionRequest, EOUserReligion, EOUserReligionDTO, UserReligionResponse> {
