...
import com.brijframework.useraccount.beans.EOGenderDetailDTO;
...
public interface GenderDetailMapper extends RQRSMapper<GenderDetailRequest, EOGenderDetail, EOGenderDetailDTO, GenderDetailResponse> {
